...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        "--snr_value", type=float, default=0.5, help="Constant value for snr value in the loss function."
    )
    parser.add_argument(
        "--learning_rate",
        type=float,
    ...
    parser.add_argument("--remove_ties", type=bool, default=True, help="Remove the pairs which have tie scores.")
    parser.add_argument(
        "--scale_lr",
        action="store_true",
        default=False,
